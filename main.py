...
labels = ['walking', 'running', 'stairs-up', 'stairs-down']
al = ActiveLearning(r'Preprocessed-data/Walking2/features_Walking2_scaled.csv', 'Walking', labels)
al.training(10)
print(f'number of errors: {al.testing(10)}')
al.plotting()
